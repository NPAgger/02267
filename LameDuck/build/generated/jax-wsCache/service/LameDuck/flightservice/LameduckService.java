 ...
 * 
 */
@WebServiceClient(name = "lameduckService", targetNamespace = "flightservice", wsdlLocation = "file:/C:/DTU/02267WebServices/Exam/02267/LameDuck/src/conf/xml-resources/web-services/LameDuck/wsdl/lameduck.wsdl")
    ...
    extends Service
{
    ...
    private final static QName LAMEDUCKSERVICE_QNAME = new QName("flightservice", "lameduckService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/DTU/02267WebServices/Exam/02267/LameDuck/src/conf/xml-resources/web-services/LameDuck/wsdl/lameduck.wsdl");
    ...
    public LameduckPortType getLameduckPortTypeBindingPort() {
        return super.getPort(new QName("flightservice", "lameduckPortTypeBindingPort"), LameduckPortType.class);
    }
    ...
    public LameduckPortType getLameduckPortTypeBindingPort(WebServiceFeature... features) {
        return super.getPort(new QName("flightservice", "lameduckPortTypeBindingPort"), LameduckPortType.class, features);
    }
